    ...
    try {
        if (success) {
            ...
            var mailOptions = {
                ...
                <center><a href='https://ancient-waters-29205.herokuapp.com/#/resetPass'><button style="color:white;background-color: dodgerblue;width: 300px;height: 40px;cursor: pointer;border-radius: 5px;outline: none;padding: 10px;border-color: dodgerblue;">Reset Password</button></a></center><br>
