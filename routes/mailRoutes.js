...
// E-mail to the respective donors
            ...
            if (success.length > 0) {
                success.forEach( (data) => {
                    ...
                    var mailOptions = {
                        ...
                        to: data.Email,
                        subject: "URGENT!",
                        html: "<p><center><strong>From BloodDonor Site</strong></center></p><p>Hi <strong>"+ data.Username +"</strong>,</p> <p> Urgently required <strong>"+ obj.BloodType +" </strong> blood type</p><p> Name: " + obj.Name + "<p><p> Age: " + obj.Age + " </p><p> Blood Type: <strong>" + obj.BloodType + "</strong> </p> <p> Blood Component: <strong>" + obj.BloodComponent + "</strong> </p>  <p> Number of Units: <strong>" + obj.Units +" </strong> units</p><p> Primary Number:  <strong>" + obj.PrimaryNumber +" </strong> </p><p> Secondary Number:  <strong>" + obj.SecondaryNumber +" </strong> </p><p> Email: " + obj.Email + "<p><p> Current Location: " + obj.CurrentLocation + "<p><p> District: " + obj.District + "<p><p> Urgency:  <strong>" + obj.Urgency +" </strong> </p><p>spread this message as soon as possible...</p>"
                    };
